package com.example.geomarketing_radiadores_fortaleza;
...
import com.example.geomarketing_radiadores_fortaleza.model.Marcador;
        ...
        databaseReference.child("locations").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnapshot : dataSnapshot.getChildren()){
                    ...
                    arrayAdapterCoordenadas=new ArrayAdapter<Marcador>(com.example.geomarketing_radiadores_fortaleza.ListViewLocations.this,
